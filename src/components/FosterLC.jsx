            ...
            <g key={index}>
              ...
              {element.type === 'inductor' && (
                <>
                  ...
                  <text x={xPosition+10} y="200" fontSize="12" fill="black">L={element.value.toFixed(2)}</text>
                </>
              )}
              ...
              {element.type === 'resonant_pair' && (
                <>
                  ...
                  <text x={xPosition+20} y="60" fontSize="12" fill="black">L={element.L.toFixed(2)}</text>
